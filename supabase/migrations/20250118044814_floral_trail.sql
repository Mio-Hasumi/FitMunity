...
-- Drop existing policies for comment_clusters
DROP POLICY IF EXISTS "Users can read own post clusters" ON comment_clusters;
DROP POLICY IF EXISTS "Users can create clusters for own posts" ON comment_clusters;
DROP POLICY IF EXISTS "Users can update clusters for own posts" ON comment_clusters;
DROP POLICY IF EXISTS "Users can delete clusters for own posts" ON comment_clusters;
